...
sa.cmd_ssh_full = "%s -qnp %d " % (sa.cmd_ssh,sa.sadm_ssh_port)           # SSH Cmd to access clients
# ==================================================================================================
