...
export REAR=$(sadm_get_command_path 'rear')                             # Full path to rear bin

# File generated by each ReaR backup
...
rear_preparation()
{
    ...
    REAR=$(sadm_get_command_path 'rear')                                # Store Path of command
    if [ "$REAR" = "" ]                                                 # If command not found
        then sadm_write_err "[ ERROR ] The 'rear' package is not installed, job aborted."
