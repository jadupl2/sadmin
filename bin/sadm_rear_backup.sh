...
# Write test to NFS Mount Point.
    ...
    sadm_write_log "New ISO will be created under the name of ${REAR_CUR_ISO}."
...
# Show content of rear directory just before starting the backup.
    sadm_write_log " "
    sadm_write_log "Content of 'ReaR' backup directory for ${SADM_HOSTNAME} : "
...
# Show the content og /etc/rear/site.conf before starting the ReaR backup
    sadm_write_log " "
    sadm_write_log "-----"
    sadm_write_log "Content of 'ReaR' site configuration file ${REAR_CFGFILE} :"
...
# Feed user and log, the what we are about to do.
    sadm_write_log " "
    sadm_write_log "-----"
    sadm_write_log "Creating 'ReaR' backup for ${SADM_HOSTNAME} : "
    sadm_write_log "-----"
