...
# 2021_05_09 Updated: v1.5 Include command line options
# --------------------------------------------------------------------------------------------------
...
export SADM_VER='1.5'                                      # Script Version
...
export SADM_MULTIPLE_EXEC="Y"                              # Run Simultaneous copy ?
...
. ${SADMIN}/lib/sadmlib_screen.sh                               # Load SADMIN Screen Standard Libr.
