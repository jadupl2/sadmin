...
# Date       :  2014-03-23
# Requires   :  bash shell
# SCCS-Id.   :  @(#) jwrapper.sh - J.Duplessis
# 
# ==================================================================================================
#set -x 
...
BASE_DIR="/sadmin"                                  ; export BASE_DIR       # Script Root Base Dir.y
...
USAGE="Usage : jwrapper path-name/script-name"      ; export USAGE          # Script Usage
