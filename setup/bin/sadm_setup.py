...
def end_message(sroot,sdomain,sserver,stype):
    ...
    writelog ("If you have any problem a reboot is recommended.")
    if (stype == "S") :
        writelog (" ")
        ...
        writelog ("  - Copy the templates included to start your new Python or Bash script.")
        writelog ("  - You can then view any script log and result file in the SADMIN web interface (or CLI).")
        writelog ("  - SADMIN is tested without SELinux 'SELINUX=disabled'.")
