...
class sadmtools:
    ...
    def __init__(self, dbname='sadmin', dbdebug=0, dbsilent=False):
        ...
        self.cfg_pguser         = ""                                                 # PostGres Database user
        self.cfg_pggroup        = ""                                                 # PostGres Database Group
        self.cfg_pgdb           = ""                                                 # PostGres Database Name
        self.cfg_pgschema       = ""                                                 # PostGres Database Schema
        self.cfg_pghost         = ""                                                 # PostGres Database Host
        self.cfg_pgport         = 5432                                               # PostGres Database Port
        self.cfg_rw_pguser      = ""                                                 # PostGres Read Write User
        self.cfg_rw_pgpwd       = ""                                                 # PostGres Read Write Pwd
        self.cfg_ro_pguser      = ""                                                 # PostGres Read Only User
        self.cfg_ro_pgpwd       = ""                                                 # PostGres Read Only Pwd
