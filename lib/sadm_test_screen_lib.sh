...
INST=`echo "$SADM_PN" | awk -F\. '{ print $1 }'`    ; export INST            # Get Current script name
...
#
# VARIABLES THAT CAN BE CHANGED PER SCRIPT -(SOME ARE CONFIGURABLE IS $SADM_BASE_DIR/cfg/sadmin.cfg)
