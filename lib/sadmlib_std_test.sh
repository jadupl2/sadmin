...
# --------------------------------------------------------------------------------------------------
    ...
    printf "\$(sadm_server_nb_logical_cpu)    Number of Logical CPU on the server (Ex: 4)                   : ...$(sadm_server_nb_logical_cpu)...\n"
    printf "\$(sadm_server_nb_cpu)            Number of Physical CPU on the server (Ex: 4)                   : ...$(sadm_server_nb_cpu)...\n"
    ...
    printf "SADM_WWW_DOC_DIR     = $SADM_WWW_DOC_DIR\n" 
