...
#   Description :  Web Page used to delete a Server Group.
#
...
# ==================================================================================================
    ...
    if (isset($_POST['submitted'])) {
        ...
        $count = pg_num_rows($row);                                     # Get Nb Server using Group
        if ($count > 0) {                                               # If Server are using Group
        ...
        $sql = "DELETE FROM sadm.group ";                               # Construct SQL Statement 
        ...
        if (!$row){                                                     # If delete didn't work
            ...
            sadm_alert("Group '" . $_POST['scr_code'] ."' deleted"); # Msg. Box for User
        }
...
# ==================================================================================================
    ...
    sadm_page_heading ("Delete a Group");                               # Display Page Heading  
    ...
    echo "\n<a href='/crud/sadm_group_main.php'>";
