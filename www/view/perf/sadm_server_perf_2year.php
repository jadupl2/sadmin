...
function create_standard_graphic( $WHOST_NAME, $WHOST_DESC , $WTYPE)
{
    ...
    switch ($WTYPE) {
        case "cpu":
            ...
            $GTITLE     = "${WHOST_NAME} - " . strtoupper($WTYPE) ." Last 2 years" ;
...
function display_graph ( $WHOST_NAME, $WHOST_DESC , $WTYPE)
{
    ...
    echo "  <tr align=left>\n";
    echo "   <td><img src=${IMGDIR}/${WHOST_NAME}_${WTYPE}_2year.png></td>\n";
    echo "  </tr>\n" ; 
    echo "</table><br><br>";
    return ;
}
...
if (isset($_GET['host']) ) { 
    ...
    echo "<center><strong><H1>Performance Graph - Last 2 years</strong></H1></center><br>";
