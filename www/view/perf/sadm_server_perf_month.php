...
function create_standard_graphic( $WHOST_NAME, $WHOST_DESC , $WTYPE, $WOS)
{
    ...
    switch ($WTYPE) {
        case "cpu":
            ...
            $GTITLE     = "${WHOST_NAME} - " . strtoupper($WTYPE) ." Last month" ;
...
function display_graph ( $WHOST_NAME, $WHOST_DESC , $WTYPE)
{
    ...
    echo "  <tr align=left>\n";
    echo "   <td><img src=${IMGDIR}/${WHOST_NAME}_${WTYPE}_month.png></td>\n";
    echo "  </tr>\n" ; 
    echo "</table><br><br>";
    return ;
}
...
if (isset($_GET['host']) ) { 
    ...
    echo "<center><strong><H1>Performance Graph - Last month</strong></H1></center><br>";
