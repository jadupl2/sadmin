...
# 2018_10_01 web v2.4 Alert Group was remove from server view (Unnecessary)
# 2018_10_22 web v2.5 Change for shorter field label
# 2018_10_28 web v2.6 Add prefix 'cfg2html_' to filename generated by cfg2html & link to files.
# 2019_01_11 web v2.7 CLicking in Server Information Button send you to update menu.
# 2019_01_19 web v2.8 Day,Date and time of Backup display according to schedule.
# 2019_01_21 web v2.9 Dark Theme, new presentation, button , perf. graph ...
# 2019_03_17 web v2.10 Volume Group Used & Free Size now show with GB unit.
# 2019_04_04 web v2.11 Adapt for Schedule_text function change in library
# 2019_07_25 web v2.12 Minor code changes
# 2019_10_15 web v2.13 Color change of input fields.
# 2020_07_12 web v2.14 Replace 'CRUD' button with 'Modify' that direct you to CRUD server menu.
# 2020_12_29 web v2.15 Date for starting & ending maintenance mode was not show properly.
#@2022_06_16 web v2.16 If o/s code name is empty, don't print the empty parentheses.
# ==================================================================================================
#
...
function display_top_buttons ($wrow) {
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        echo "\n<a href='" . $wname . "?filename=". $fname ;            # Build URL 
        echo "' class='button' data-toggle='tooltip' title='Network Info'>";           # Tool Tips
        #echo "<button type='button'>Network Info</button></a>";         # Display Button
        echo "Network</a>";         # Display Button
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        echo "\n<a href='" . $wname . "?filename=". $fname ;            # Build URL 
        echo "' class='button' data-toggle='tooltip' title='System Summary'>";         # Tool Tips
        #echo "<button type='button'>Server Summary</button></a>";      # Display Button
        echo "Summary</a>";                                      # Display Button
    }
    ...
    if (file_exists($fname)) {                                          # If rrd exist for server
        echo "\n<a href='" . $wname . $wrow['srv_name'] ;               # Build URL 
        echo "' class='button' data-toggle='tooltip' title='Show Performance Graph of Server'>";
        echo "Perf. Graph</a>";                                   # Display Button
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        ...
        echo "' class='button' data-toggle='tooltip' title='CFG2HTML Information'>";   # Tool Tips
        echo "cfg2html</a>";        # Display Button
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        echo "\n<a href='" . $wname . "?filename=". $fname ;            # Build URL 
        echo "' class='button' data-toggle='tooltip' title='Disk Information'>";       # Tool Tips
        #echo "<button type='button'>Disk(s) Info</button></a>";         # Display Button
        echo "Disk(s)</a>";         # Display Button
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        echo "\n<a href='" . $wname . "?filename=". $fname ;            # Build URL 
        echo "' class='button' data-toggle='tooltip' title='LVM Info'>";               # Tool Tips
        echo "LVM</a>";                  # Display Button
    }
