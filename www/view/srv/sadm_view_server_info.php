...
function display_top_buttons ($wrow) {
    ...
    $wname="/crud/srv/sadm_server_backup.php?sel=$wserver"; 
    $BUTTON_URL = "${wname}&back=${URL_VIEW_SERVERS}?selection=all_servers";
    echo "\n<a href='" . $BUTTON_URL . "'>";                        
    echo "<span ' class='button' data-toggle='tooltip' title='Backup schedule for $wserver'>";  
    echo "<img src='/images/backup2.png' style='width:32px;height:32px';>&nbsp</span></a>";

    # Display Button to O/S Update Schedule.
    $wserver = $wrow['srv_name'];
    $wname="${URL_OSUPDATE}?sel=$wserver"; 
    $BUTTON_URL = "${wname}&back=${URL_VIEW_SERVERS}?selection=all_servers";
    echo "\n<a href='" . $BUTTON_URL . "'>";                        
