...
# ==================================================================================================
# ChangeLog
# 2017_10_10 web v1.00 System info page - Initial version
# 2017_10_21 web v1.01 System info page - Replace PostGres Database with MySQL 
# 2017_11_09 web v1.02 System info page - Web Interface changed for ease of maintenance.
# 2018_01_04 web v2.01 System info page - Add Button at bottom of page to show more System Info.
# 2018_02_08 web v2.02 System info page - Rework page design and button at bottom of page
# 2018_04_07 web v2.03 System info page - Change Page & Fixes some bugs
# 2018_10_01 web v2.04 System info page - Alert Group was remove from server view (Unnecessary)
# 2018_10_22 web v2.05 System info page - Change for shorter field label
# 2018_10_28 web v2.06 System info page - Add prefix 'cfg2html_' to filename generated by cfg2html & link to files.
# 2019_01_11 web v2.07 System info page - CLicking in Server Information Button send you to update menu.
# 2019_01_19 web v2.08 System info page - Day,Date and time of Backup display according to schedule.
# 2019_01_21 web v2.09 System info page - Dark Theme, new presentation, button , perf. graph ...
# 2019_03_17 web v2.10 System info page - Volume Group Used & Free Size now show with GB unit.
# 2019_04_04 web v2.11 System info page - Adapt for Schedule_text function change in library
# 2019_07_25 web v2.12 System info page - Minor code changes
...
a:hover     { color: white;     background-colsadm_view_server_infoor: transparent; text-decoration: underline; }
...
function display_top_buttons ($wrow) {
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        ...
        echo "<img src='/images/sadm_computer_0.png' ";                 # Show Info Icon
        echo "style='width:32px;height:32px;'>System Info</span></a>";
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        ...
        echo "<img src='/images/sadm_network_0.png' ";                    # Show Info Icon
        echo "style='width:32px;height:32px;'>&nbspNetwork Info</span></a>";
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        ...
        echo "<img src='/images/sadm_summary_0.png' ";                    # Show Info Icon
    ...
    if (file_exists($fname)) {                                          # If rrd exist for server
        ...
        echo "style='width:32px;height:32px;'>&nbspPerf. Graph</span></a>";
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        ...
        echo "style='width:32px;height:32px;'>&nbspcfg2html</span></a>";
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        $BUTTON_URL = "${wname}?filename=${fname} ";                    # Build URL to file
        echo "\n<a href='" . $BUTTON_URL . "'>";                        # URL to See information
        echo "<span ' class='button' data-toggle='tooltip' title='View disk(s) info'>";  
        echo "<img src='/images/sadm_disk_0.png' ";                    # Show Info Icon
        echo "style='width:32px;height:32px;'>&nbspDisk(s)</span></a>";
    }
    ...
    if (file_exists($fname)) {                                          # If FileName Received exist
        $BUTTON_URL = "${wname}?filename=${fname} ";                    # Build URL to file
        echo "\n<a href='" . $BUTTON_URL . "'>";                        # URL to See information
        echo "<span ' class='button' data-toggle='tooltip' title='Logical Volume Manager info'>";  
        echo "<img src='/images/sadm_lvm_0.jpg' style='width:32px;height:32px';>&nbspLVM info</span></a>";
    }

    # Display the Update Button
    echo "\n<a href='" . $URL_MENU . "?sel=" . $wrow['srv_name'] . "&back=" . $URL_VIEW . "'>" ;
    echo "<span ' class='button' data-toggle='tooltip' title='Edit system info'>";  
    echo "<img src='/images/sadm_edit_0.png' style='width:32px;height:32px;'>&nbspEdit system</span></a>";
