...
# ==================================================================================================
# Display Static portion of system information
#
# Parameter: 
#   - Array containing table row keys/values (Returned by MySql Statement)
# Return value: 
#   - 0 = Success 
#   - 1 = Error while showing info
# ==================================================================================================
function display_static_info ($wrow) {
    ...
    echo "\n<table border=1 wrap width='90%'>";
    
    echo "<tr>\n";
    list($ipath, $iurl, $ititle) = sadm_return_logo ($wrow['srv_osname']) ;
    echo "<td width=40 rowspan='5'>\n";
    echo "<a href='" . $iurl . "'><img src='" . $ipath ;
    echo " 'style='width:32px;height:32px;'></a></td>\n";
    echo "</tr>\n"; 

    echo "<tr>\n";
    echo "<td width=60 ><strong>Name: </strong></td>\n" ; 
    echo "<td>\n";
    echo "Name: ". trim($wrow['srv_name']) . "." . trim($wrow['srv_domain']);
    echo "</td>\n"; 
    echo "</tr>\n";
    ...
    echo "<tr>\n";
    echo "<td><strong>Kernel: </strong></td>\n" ; 
    echo "<td>\n";   
