...
function display_record( $wrow , $title) {
    ...
    echo "<tr>\n";
    echo "<td><input type='text' name='scr_code' size=10 value='" .$wrow['cat_code']. "'readonly>\n";
    echo "</td>\n";
    echo "</tr>\n";
    echo "</table>\n";
    echo "<br>\n";
    ...
    echo "<tr>\n";
    echo "<td bgcolor=$BGCOLOR><b>Category Description</b></td>\n";
    echo "<td><input type='text' name='scr_desc' size=30 value='" .$wrow['cat_desc']. "'/></td>\n";
    echo "</tr>\n";
...
*/
        ...
        if (isset($_POST['submitted'])) {
            ...
            $sql2 = "cat_code       = '" . $_POST['scr_code']   ."', ";
            $sql3 = "cat_desc       = '" . $_POST['scr_desc']   ."', ";
            $sql4 = "cat_status     = '" . $_POST['scr_status'] ."'  ";
            $sql5 = "WHERE cat_code = '" . $_POST['scr_code']   ."'; ";
            ...
            if (!$row){  
                ...
                echo "<br>Problem with Command :" . $sql ;
                echo "<br>pg_last_error()"  ;
            }else{  
                echo "<br>Update successfull<br>";  
            }  
            echo "<a href=http://sadmin/sadmin/sadm_category_main.php>Return to Categories List</a>";
            exit;
        }else{
            if (isset($_GET['sel']) ) {
                $wkey = $_GET['sel'];
...
?>
    ...
    <form name="cat_edit" action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method='POST'>
        <br>
        <?php display_record( $row , "Edit Category Information"); ?>
